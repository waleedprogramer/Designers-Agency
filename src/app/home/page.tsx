...
function Main() {
  ...
  <div className="h-1/2 flex lg:flex-row justify-around flex-col pt-36">
    <div className="content flex flex-col justify-center text-center lg:w-1/2	">
      ...
      <p className='mt-3 text-md'>We are a creative design studio specializing in meeting the needs of the new generation. We offer innovative and cutting-edge design solutions to help our clients stand out in today's fast-paced.</p>
      <span>
